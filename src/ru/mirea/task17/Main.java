...
public class Main {
    public static void main(String[] args) {
        ...
        int planet;
        while (true) {
            System.out.println("Введите номер планеты от 1 до 8 по удаленности от солнца или 0 для завершения программы: ");
            planet = sc.nextInt();
            Planet pl;
            if (planet < 9 && planet != 0) {
                ...
                System.out.println("Нет планеты с таким номером.");
        }
    }
}
